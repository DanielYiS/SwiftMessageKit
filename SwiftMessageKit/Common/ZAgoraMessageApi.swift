...
public class ZAgoraMessageApi: NSObject {
    ...
    /// 准备发送文本消息
    final func sendTextMessage(_ text: String, receive: ZModelMessageUser, messageid: String) {
    ...
    /// 准备发送图片消息
    final func sendImageMessage(_ mediaId: String, receive: ZModelMessageUser, messageid: String) {
    ...
    /// 准备发送文件消息
    final func sendFileMessage(_ mediaId: String, receive: ZModelMessageUser, messageid: String) {
