...
public class ZMessageRecordAudioView: UIView {
    ...
    private lazy var viewBG: UIView = {
        ...
        z_item_view.alpha = 0.7
        z_item_view.backgroundColor = .black
    ...
    private lazy var imageCancel: UIImageView = {
        let z_item_image = UIImageView.init(image: UIImage(named: "RecordCancel", in: Bundle.messageKitAssetBundle, compatibleWith: nil))
        
        return z_item_image
    }()
    private lazy var imageAudio: UIImageView = {
        let z_item_image = UIImageView.init(image: UIImage(named: "RecordingBkg", in: Bundle.messageKitAssetBundle, compatibleWith: nil))
