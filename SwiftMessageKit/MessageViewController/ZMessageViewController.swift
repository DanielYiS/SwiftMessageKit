...
open class ZMessageViewController: MessagesViewController {
    ...
    /// 输入框边框宽度
    public var inputViewBorderWidth: CGFloat = 0
    /// 输入框边框颜色
    public var inputViewBorderColor: UIColor = UIColor.clear
    /// 输入框提示文本颜色
    ...
    private func innerInitView() {
        ...
        self.messageInputBar.inputTextView.border(color: inputViewBorderColor, radius: self.inputViewBorderRadius, width: inputViewBorderWidth)
