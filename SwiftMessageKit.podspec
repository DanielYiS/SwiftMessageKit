...
# 3. pod repo push SwiftMessageKit SwiftMessageKit.podspec --sources='https://github.com/CocoaPods/Specs.git'
...
Pod::Spec.new do |s|
  ...
  s.resource_bundle     = { 'SwiftMessageKit' => 'SwiftMessageKit/**/*.xcassets' }
  s.public_header_files = 'SwiftMessageKit/**/*.h'
