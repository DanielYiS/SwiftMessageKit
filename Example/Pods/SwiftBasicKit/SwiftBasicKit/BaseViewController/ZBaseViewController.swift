...
open class ZBaseViewController: UIViewController {
    ...
    open var imageBack: UIImage? = UIImage.baseImage(named: "btn_back")
    ...
    public final func setNavBarLeftButton(isBack: Bool = true) {
        self.navigationItem.leftBarButtonItem = nil
        self.navigationItem.backBarButtonItem = nil
        if isBack, let coun = self.navigationController?.viewControllers.count, coun <= 1 {
            return
        }
