...
extension UIImageView {
    ...
    public func setPhotoWitUrl(strUrl: String) {
        ...
        self.setImageWitUrl(strUrl: strUrl, placeholder: UIImage.init(named: "default_avatar"))
    }
    public func setImageWitUrl(strUrl: String, placeholder: UIImage? = UIImage.init(named: "default_image")) {
