...
public class ZBaseTV: UITableView {
    ...
    public func addBackgroundStatus(text: String, color: UIColor, image: UIImage? = UIImage.baseImage(named: "default_nothing")) {
    ...
    private lazy var imageStatus: UIImageView = {
        let item = UIImageView.init(image: UIImage.baseImage(named: "default_nothing"))
