...
public class ZModelUserLogin: ZModelBase {
    ...
    public var is_black: Bool = false
    public var black_count: Int = 0
    public var is_follow: Bool = false
    public var follow_count: Int = 0
    ...
    public required init<T: ZModelBase>(instance: T) {
        ...
        self.is_black = model.is_black
        self.black_count = model.black_count
        self.is_follow = model.is_follow
        self.follow_count = model.follow_count
    }
