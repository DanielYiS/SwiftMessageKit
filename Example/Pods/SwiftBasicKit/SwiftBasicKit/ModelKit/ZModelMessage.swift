...
public class ZModelMessage: ZModelBase {
    ...
    enum Columns: String, ColumnExpression {
        case message_userid, login_userid, message_id, message, message_type, message_direction, message_time, message_send_state, message_read_state, message_unread_count, message_file_id, message_file_path, message_file_size, message_can_call_back
    }
